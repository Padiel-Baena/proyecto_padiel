...
public class LecturaFicherosTexto {
    ...
    public static void main(String[] args) {
        String fileName = "datosPadiel.txt";
        String fileName1 = "/home/pabbaetel/Desktop/proyecto_padiel/datosPadiel.txt";
        ...
        try{
            ...
            while (i != -1) {
                ...
                // Reads next byte from the filenew FileInputStream
                i = input.read();
            }
            input.close();
