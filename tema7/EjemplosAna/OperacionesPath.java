...
public class OperacionesPath {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path unPath = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/src/tema7/");
        Path otroPath = Paths.get("/home/pabbaetel/Desktop/proyecto_padiel/src");

        // Obtener el nombre de un fichero y unirlo a la ruta de otro directorio
        Path unFile = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/datosPadiel.txt");
        Path unDir = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/NuevaCarpeta");
        // /home/user/file.txt
        System.out.println(unDir.resolve(unFile.getFileName()));

        System.err.println("Primer print");

        // Relativizar una ruta respecto a otra
        Path otroFile = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/datosAna.txt");
        Path otroDir = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/carpetaPrueba");
        // obtener c/d.txt
        System.out.println(otroDir.relativize(otroFile));
        System.err.println("Segundo print");
        ...
        Files.createDirectories(Path.of("/home/pabbaetel/Desktop/proyecto_padiel/src/tema7"));

        // Imprimir el contenido de un directorio
        Files.list(Path.of("/home/pabbaetel/Desktop/proyecto_padiel")).forEach(System.out::println);

        // Obtener la lista de los contenidos anidados de un directorio
        List<Path> list = Files.walk(Paths.get("/home/pabbaetel/Desktop/proyecto_padiel/src")).collect(Collectors.toList());

        // Imprimir los ficheros regulares de un directorio ordenados por tamaño
        Files.list(Path.of("/home/pabbaetel/Desktop/proyecto_padiel/carpetaPrueba"))
        ...
        System.err.println("Tercer print");

        //imprimir los ficheros regulares de un directorio ordenados por tamaño sin programación funcional
        Path directorio = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/carpetaPrueba");
        ...
        for (Path archivo : archivos) {
            ...
            System.err.println("otro print");
        }

        // Obtener el año, mes y día de la fecha de la última modificación
        Path file = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/datosAna.txt");
        ...
        System.err.println("Mas print");

        // Operaciones con ficheros
        Path original = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/datosPadiel.txt");
        Path backup = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/datosPadiel.txt.backup");
        Path rename = Path.of("/home/pabbaetel/Desktop/proyecto_padiel/datosPadiel.txt.backup.1");
