...
public class C1 {
    ...
    public static void main(String[] args) {
        // 1. CARGA INICIAL (Nada más abrirse)
        // Para el Ejercicio 2, cambia cargarCSV() por cargarSerial()
        ...
        // 2. GUARDADO AL SALIR
        // Para el Ejercicio 2, cambia guardarCSV por guardarSerial
    ...
    // Métodos auxiliares para evitar errores al leer números
